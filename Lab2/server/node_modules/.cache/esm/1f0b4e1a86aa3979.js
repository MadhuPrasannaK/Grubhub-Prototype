let connection,mongoose;_86a‍.w("../kafka/connection",[["default",["connection"],function(v){connection=v}]]);_86a‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);
...
function handleTopicRequest(topic_name, fname) {
    ...
    consumer.on('message', function (message) {
        _86a‍.g.console.log('message received for ' + topic_name + " ", fname);
        _86a‍.g.console.log(JSON.stringify(message.value));
        var data = JSON.parse(message.value);

        fname.handle_request(data.data, (err, res) => {
            _86a‍.g.console.log('after handle' + res);
            var payloads = [{
                topic: data.replyTo,
