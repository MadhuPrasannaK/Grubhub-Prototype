let express;_bae‍.x([["default",()=>_bae‍.o]]);_bae‍.w("express",[["default",["express"],function(v){express=v}]]);
...
orderRouter.get("/order/buyer/:user_id", (req, res) => {
    ...
    _bae‍.g.console.log("Here:", req.params.user_id)
...
orderRouter.post("/message/push", (req, res) => {
    ...
    _bae‍.g.console.log("Message Details:", req.body)
